...
from db import actualizar_instrumento, crear_instrumento, crear_inversion, crear_precio, obtener_instrumento_por_id, obtener_instrumentos, obtener_inversiones, obtener_precios, obtener_instrumentos_con_precios
